...
extern "C" {
    pub fn ckzg_load_trusted_setup(
        out: *mut KZGSettings,
        g1_bytes: *const u8,
        n1: usize,
        g2_bytes: *const u8,
    ...
    pub fn ckzg_load_trusted_setup_file(out: *mut KZGSettings, in_: *mut FILE) -> C_KZG_RET;
    pub fn ckzg_free_trusted_setup(s: *mut KZGSettings);
    pub fn ckzg_blob_to_kzg_commitment(
        out: *mut KZGCommitment,
        blob: *const Blob,
        s: *const KZGSettings,
    ) -> C_KZG_RET;
    pub fn ckzg_compute_kzg_proof(
    ...
    pub fn ckzg_compute_blob_kzg_proof(
        out: *mut KZGProof,
        blob: *const Blob,
        commitment_bytes: *const Bytes48,
        s: *const KZGSettings,
    ) -> C_KZG_RET;
    pub fn ckzg_verify_kzg_proof(
        ok: *mut bool,
        commitment_bytes: *const Bytes48,
        z_bytes: *const Bytes32,
    ...
    pub fn ckzg_verify_blob_kzg_proof(
        ok: *mut bool,
        blob: *const Blob,
        commitment_bytes: *const Bytes48,
        proof_bytes: *const Bytes48,
    ...
    pub fn ckzg_verify_blob_kzg_proof_batch(
        ok: *mut bool,
        blobs: *const Blob,
