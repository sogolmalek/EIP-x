...
func TestPointBls12381G2Generator(t *testing.T) {
	...
	s, ok := sc.(*PointBls12381G2)
	require.True(t, ok)
	require.Equal(t, 1, s.Value.Equal(new(bls123812.G2).Generator()))
}
...
func TestPointBls12381G2Set(t *testing.T) {
	...
	generator := new(bls123812.G2).Generator().ToUncompressed()
...
func TestPointBls12381G1Set(t *testing.T) {
	...
	require.NoError(t, err)
	require.True(t, iden.IsIdentity())
	generator := new(bls123812.G1).Generator().ToUncompressed()
