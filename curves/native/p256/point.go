...
var (
	...
	p256PointParams       native2.EllipticPointParams
	p256PointSswuInitOnce sync.Once
	p256PointSswuParams   native2.SswuParams
)

func P256PointNew() *native2.EllipticPoint {
	return &native2.EllipticPoint{
		X:          fp.P256FpNew(),
		Y:          fp.P256FpNew(),
		Z:          fp.P256FpNew(),
...
func p256PointParamsInit() {
	...
	p256PointParams = native2.EllipticPointParams{
		A:       fp.P256FpNew().SetRaw(&[native2.FieldLimbs]uint64{0xfffffffffffffffc, 0x00000003ffffffff, 0x0000000000000000, 0xfffffffc00000004}),
		B:       fp.P256FpNew().SetRaw(&[native2.FieldLimbs]uint64{0xd89cdf6229c4bddf, 0xacf005cd78843090, 0xe5a220abf7212ed6, 0xdc30061d04874834}),
		Gx:      fp.P256FpNew().SetRaw(&[native2.FieldLimbs]uint64{0x79e730d418a9143c, 0x75ba95fc5fedb601, 0x79fb732b77622510, 0x18905f76a53755c6}),
		Gy:      fp.P256FpNew().SetRaw(&[native2.FieldLimbs]uint64{0xddf25357ce95560a, 0x8b4ab8e4ba19e45c, 0xd2e88688dd21f325, 0x8571ff1825885d85}),
		BitSize: 256,
		Name:    "P256",
	}
}

func getP256PointParams() *native2.EllipticPointParams {
	p256PointInitonce.Do(p256PointParamsInit)
	return &p256PointParams
}

func getP256PointSswuParams() *native2.SswuParams {
...
func p256PointSswuParamsInit() {
	...
	p256PointSswuParams = native2.SswuParams{
		C1: [native2.FieldLimbs]uint64{0xffffffffffffffff, 0x000000003fffffff, 0x4000000000000000, 0x3fffffffc0000000},
		C2: [native2.FieldLimbs]uint64{0x53e43951f64fdbe7, 0xb2806c63966a1a66, 0x1ac5d59c3298bf50, 0xa3323851ba997e27},
		A:  [native2.FieldLimbs]uint64{0xfffffffffffffffc, 0x00000003ffffffff, 0x0000000000000000, 0xfffffffc00000004},
		B:  [native2.FieldLimbs]uint64{0xd89cdf6229c4bddf, 0xacf005cd78843090, 0xe5a220abf7212ed6, 0xdc30061d04874834},
		Z:  [native2.FieldLimbs]uint64{0xfffffffffffffff5, 0x0000000affffffff, 0x0000000000000000, 0xfffffff50000000b},
	}
}

type p256PointArithmetic struct{}

func (k p256PointArithmetic) Hash(out *native2.EllipticPoint, hash *native2.EllipticPointHasher, msg, dst []byte) error {
	var u []byte
	sswuParams := getP256PointSswuParams()

	switch hash.Type() {
	case native2.XMD:
		u = native2.ExpandMsgXmd(hash, msg, dst, 96)
	case native2.XOF:
		u = native2.ExpandMsgXof(hash, msg, dst, 96)
	}
	var buf [64]byte
...
func (k p256PointArithmetic) Double(out, arg *native2.EllipticPoint) {
	// Addition formula from Renes-Costello-Batina 2015
	// (https://eprint.iacr.org/2015/1060 Algorithm 6)
	var xx, yy, zz, xy2, yz2, xz2, bzz, bzz3 [native2.FieldLimbs]uint64
	var yyMBzz3, yyPBzz3, yFrag, xFrag, zz3 [native2.FieldLimbs]uint64
	var bxz2, bxz6, xx3Mzz3, x, y, z [native2.FieldLimbs]uint64
...
func (k p256PointArithmetic) Add(out, arg1, arg2 *native2.EllipticPoint) {
	// Addition formula from Renes-Costello-Batina 2015
	// (https://eprint.iacr.org/2015/1060 Algorithm 4).
	var xx, yy, zz, zz3, bxz, bxz3 [native2.FieldLimbs]uint64
	var tv1, xyPairs, yzPairs, xzPairs [native2.FieldLimbs]uint64
	var bzz, bzz3, yyMBzz3, yyPBzz3 [native2.FieldLimbs]uint64
	var xx3Mzz3, x, y, z [native2.FieldLimbs]uint64
	f := arg1.X.Arithmetic
	b := getP256PointParams().B.Value
...
func (k p256PointArithmetic) IsOnCurve(arg *native2.EllipticPoint) bool {
	affine := P256PointNew()
...
func (k p256PointArithmetic) ToAffine(out, arg *native2.EllipticPoint) {
	var wasInverted int
	var zero, x, y, z [native2.FieldLimbs]uint64
	f := arg.X.Arithmetic
...
func (k p256PointArithmetic) RhsEq(out, x *native2.Field) {
