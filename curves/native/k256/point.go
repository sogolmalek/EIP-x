...
import (
	...
	"curveLib-lfzkoala/curves/native/k256/fp"
	"sync"
...
var (
	...
	k256PointParams          native2.EllipticPointParams
	k256PointSswuInitOnce    sync.Once
	k256PointSswuParams      native2.SswuParams
	k256PointIsogenyInitOnce sync.Once
	k256PointIsogenyParams   native2.IsogenyParams
)

func K256PointNew() *native2.EllipticPoint {
...
func k256PointParamsInit() {
	k256PointParams = native2.EllipticPointParams{
		...
		Gx: fp.K256FpNew().SetLimbs(&[native2.FieldLimbs]uint64{
			0x59f2815b16f81798,
			0x029bfcdb2dce28d9,
			0x55a06295ce870b07,
			0x79be667ef9dcbbac,
		}),
		Gy: fp.K256FpNew().SetLimbs(&[native2.FieldLimbs]uint64{
			0x9c47d08ffb10d4b8,
			0xfd17b448a6855419,
			0x5da4fbfc0e1108a8,
			0x483ada7726a3c465,
...
func getK256PointParams() *native2.EllipticPointParams {
	k256PointInitonce.Do(k256PointParamsInit)
	return &k256PointParams
}

func getK256PointSswuParams() *native2.SswuParams {
...
func k256PointSswuParamsInit() {
	...
	k256PointSswuParams = native2.SswuParams{
		// (q -3) // 4
		C1: [native2.FieldLimbs]uint64{0xffffffffbfffff0b, 0xffffffffffffffff, 0xffffffffffffffff, 0x3fffffffffffffff},
		// sqrt(-z^3)
		C2: [native2.FieldLimbs]uint64{0x5b57ba53a30d1520, 0x908f7cef34a762eb, 0x190b0ffe068460c8, 0x98a9828e8f00ff62},
		// 0x3f8731abdd661adca08a5558f0f5d272e953d363cb6f0e5d405447c01a444533
		A: [native2.FieldLimbs]uint64{0xdb714ce7b18444a1, 0x4458ce38a32a19a2, 0xa0e58ae2837bfbf0, 0x505aabc49336d959},
		// 1771
		B: [native2.FieldLimbs]uint64{0x000006eb001a66db, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000},
		// -11
		Z: [native2.FieldLimbs]uint64{0xfffffff3ffffd234, 0xffffffffffffffff, 0xffffffffffffffff, 0xffffffffffffffff},
	}
}

func k256PointIsogenyInit() {
	k256PointIsogenyParams = native2.IsogenyParams{
		XNum: [][native2.FieldLimbs]uint64{
			{
				0x0000003b1c72a8b4,
				0x0000000000000000,
				0x0000000000000000,
		...
		XDen: [][native2.FieldLimbs]uint64{
			{
				0x8af79c1ffdf1e7fa,
				0xb84bc22235735eb5,
				0x82ee5655a55ace04,
		...
		YNum: [][native2.FieldLimbs]uint64{
			{
				0xffffffce425e12c3,
				0xffffffffffffffff,
				0xffffffffffffffff,
		...
		YDen: [][native2.FieldLimbs]uint64{
			{
				0xfffffd0afff4b6fb,
				0xffffffffffffffff,
				0xffffffffffffffff,
...
func getK256PointIsogenyParams() *native2.IsogenyParams {
...
func (k k256PointArithmetic) Hash(out *native2.EllipticPoint, hash *native2.EllipticPointHasher, msg, dst []byte) error {
	var u []byte
...
func (k k256PointArithmetic) Double(out, arg *native2.EllipticPoint) {
	// Addition formula from Renes-Costello-Batina 2015
	// (https://eprint.iacr.org/2015/1060 Algorithm 9)
	var yy, zz, xy2, bzz, bzz3, bzz9 [native2.FieldLimbs]uint64
	var yyMBzz9, yyPBzz3, yyzz, yyzz8, t [native2.FieldLimbs]uint64
	var x, y, z [native2.FieldLimbs]uint64
	f := arg.X.Arithmetic
...
func (k k256PointArithmetic) Add(out, arg1, arg2 *native2.EllipticPoint) {
	// Addition formula from Renes-Costello-Batina 2015
	// (https://eprint.iacr.org/2015/1060 Algorithm 7).
	var xx, yy, zz, nXxYy, nYyZz, nXxZz [native2.FieldLimbs]uint64
	var tv1, tv2, xyPairs, yzPairs, xzPairs [native2.FieldLimbs]uint64
	var bzz, bzz3, yyMBzz3, yyPBzz3, byz [native2.FieldLimbs]uint64
	var byz3, xx3, bxx9, x, y, z [native2.FieldLimbs]uint64
	f := arg1.X.Arithmetic
...
func (k k256PointArithmetic) IsOnCurve(arg *native2.EllipticPoint) bool {
	affine := K256PointNew()
...
func (k k256PointArithmetic) ToAffine(out, arg *native2.EllipticPoint) {
	var wasInverted int
...
func (k k256PointArithmetic) RhsEq(out, x *native2.Field) {
