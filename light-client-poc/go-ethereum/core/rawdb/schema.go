...
var (
	...
	// Access list
	accessListPrefix = []byte("L") // skeletonHeaderPrefix + num (uint64 big endian) -> header
...
// accessListKey = AccessListPrefix + hash
func accessListKey(block *big.Int) []byte {
	blockBytes := make([]byte, 8)
	binary.BigEndian.PutUint64(blockBytes, block.Uint64())

	return append(accessListPrefix, blockBytes...)
}
